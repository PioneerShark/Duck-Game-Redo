...
public interface IAudioService : IFrameworkService
{
    ...
    AudioSource PlaySFX(AudioClip audioClip, Transform spawnTransform, float volume);
    AudioSource PlaySFX(AudioClip audioClip, Vector3 spawnPosition, float volume);
